...
Accent:
  brand:      #F97316 (orange-500)    -- 品牌色（🦀 crab orange）
...
│  │ 🦀 nanocrab-main  🟢 │ │ user:123  08:42  main │ │
│  │ 🛠️ nanocrab-builder 🟢│ │ user:456  08:35  main │ │
│  │                      │ │ user:789  08:20  bldr  │ │
│  └──────────────────────┘ └────────────────────────┘ │
└──────────────────────────────────────────────────────┘
...
┌──────────────────────────────────────────────────────┐
│  ← Agents / nanocrab-main              [Save] [Disable]│
├──────────────────────────────────────────────────────┤
│                                                      │
...
│  Identity Tab:                                       │
│  ┌──────────────────────────────────────────────────┐│
│  │ Agent ID        nanocrab-main                    ││
│  │ Display Name    [nanocrab          ]             ││
│  │ Emoji           [🦀                ]             ││
...
│  │   08:42 • 12 messages   │  Agent: nanocrab-main  ││
│  │                         │  Started: 08:30:15     ││
...
|-------|------------|--------|
| **Phase 1** | Backend: nanocrab-server crate with axum + CORS + SSE | High |
