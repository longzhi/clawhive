...
fn to_search_config(config: &MemorySearchConfig) -> SearchConfig {
    SearchConfig {
        ...
        hot_days: config.temperature.hot_days,
        warm_days: config.temperature.warm_days,
        cold_filter: config.temperature.cold_filter,
        access_protect_count: config.temperature.access_protect_count,
